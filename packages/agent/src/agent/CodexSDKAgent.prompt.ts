/**
 * Codex SDK specific system prompt for browser automation
 * Note: Uses same browser control tools as ClaudeSDKAgent via MCP
 */
export const CODEX_SDK_SYSTEM_PROMPT = `You are a browser automation assistant with access to specialized browser control tools.
